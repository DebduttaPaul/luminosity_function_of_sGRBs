...
def model_BPL__Swift( x__Swift_short, Gamma, nu1, nu2, coeff ):
...
Gamma_l = 2.0	;	nu1_l = 0.10 ; nu2_l = 2.00 ; coeff_l = 0.30

lower_bounds	=	[ 1e-3, 1e-3, 1e-3, 1e-3 ]
upper_bounds	=	[ 1e+1,  1e0,  6e0, 1e+2 ]
...
#~ popt__BATSE, pcov__BATSE	=	curve_fit( model_BPL__BATSE, x__BATSE_short, y__BATSE_short/N__BATSE, sigma = y__BATSE_short_error/N__BATSE, absolute_sigma =  True, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
#~ popt__BATSE, pcov__BATSE	=	curve_fit( model_BPL__BATSE, x__BATSE_short, y__BATSE_short/N__BATSE, sigma = y__BATSE_short_error/N__BATSE, absolute_sigma = False, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
popt__BATSE, pcov__BATSE	=	curve_fit( model_BPL__BATSE, x__BATSE_short, y__BATSE_short/N__BATSE, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
model_fit__BATSE			=	model_BPL__BATSE( x__BATSE_short, *popt__BATSE )  * N__BATSE
Gamma__BATSE=	popt__BATSE[0]
nu1__BATSE	=	popt__BATSE[1]
nu2__BATSE	=	popt__BATSE[2]
coeff__BATSE=	popt__BATSE[3]
...
ax.legend()
plt.savefig( './../plots/3param--BATSE--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
...
#~ popt__Fermi, pcov__Fermi	=	curve_fit( model_BPL__Fermi, x__Fermi_short, y__Fermi_short/N__Fermi, sigma = y__Fermi_short_error/N__Fermi, absolute_sigma =  True, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
#~ popt__Fermi, pcov__Fermi	=	curve_fit( model_BPL__Fermi, x__Fermi_short, y__Fermi_short/N__Fermi, sigma = y__Fermi_short_error/N__Fermi, absolute_sigma = False, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
popt__Fermi, pcov__Fermi	=	curve_fit( model_BPL__Fermi, x__Fermi_short, y__Fermi_short/N__Fermi, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
model_fit__Fermi			=	model_BPL__Fermi( x__Fermi_short, *popt__Fermi ) * N__Fermi
Gamma__Fermi=	popt__Fermi[0]
nu1__Fermi	=	popt__Fermi[1]
nu2__Fermi	=	popt__Fermi[2]
coeff__Fermi=	popt__Fermi[3]
...
ax.legend()
plt.savefig( './../plots/3param--Fermi--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
...
#~ popt__Swift, pcov__Swift	=	curve_fit( model_BPL__Swift, x__Swift_short, y__Swift_short/N__Swift, sigma = y__Swift_short_error/N__Swift, absolute_sigma =  True, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
#~ popt__Swift, pcov__Swift	=	curve_fit( model_BPL__Swift, x__Swift_short, y__Swift_short/N__Swift, sigma = y__Swift_short_error/N__Swift, absolute_sigma = False, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
popt__Swift, pcov__Swift	=	curve_fit( model_BPL__Swift, x__Swift_short, y__Swift_short/N__Swift, p0 = [Gamma_l, nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
model_fit__Swift			=	model_BPL__Swift( x__Swift_short, *popt__Swift )  * N__Swift
Gamma__Swift=	popt__Swift[0]
nu1__Swift	=	popt__Swift[1]
nu2__Swift	=	popt__Swift[2]
coeff__Swift=	popt__Swift[3]
...
ax.legend()
plt.savefig( './../plots/3param--Swift--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
