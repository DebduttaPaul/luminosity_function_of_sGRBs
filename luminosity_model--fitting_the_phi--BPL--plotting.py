...
def model_BPL__Fermi( x__Fermi_short, nu1, nu2, coeff, delta, chi ):
...
def model_BPL__Swift( x__Swift_short, nu1, nu2, coeff, delta, chi ):
...
def model_BPL__BATSE( x__BATSE_short, nu1, nu2, coeff, delta, chi ):
...
nu1__Fermi = 0.791 ; nu2__Fermi = 2.685 ; coeff__Fermi = 0.123 ; delta__Fermi = 4.271 ; chi__Fermi = -0.009
nu1__Swift = 1.093 ; nu2__Swift = 2.983 ; coeff__Swift = 3.000 ; delta__Swift = 2.953 ; chi__Swift = -1.724
nu1__BATSE = 0.590 ; nu2__BATSE = 1.839 ; coeff__BATSE = 0.072 ; delta__BATSE = 5.000 ; chi__BATSE = -1.215
...
#~ model_fit__Fermi	=	model_BPL__Fermi( x__Fermi_short, nu1__Fermi, nu2__Fermi, coeff__Fermi, delta__Fermi, chi__Fermi ) * N__Fermi
model_fit__Fermi	=	model_BPL__Fermi( x__Fermi_short, nu1__BATSE, nu2__BATSE, coeff__BATSE, delta__BATSE, chi__BATSE ) * N__Fermi
...
#~ model_fit__Swift	=	model_BPL__Swift( x__Swift_short, nu1__Swift, nu2__Swift, coeff__Swift, delta__Swift, chi__Swift ) * N__Swift
#~ model_fit__Swift	=	model_BPL__Swift( x__Swift_short, nu1__Fermi, nu2__Fermi, coeff__Fermi, delta__Fermi, chi__Fermi ) * N__Swift
model_fit__Swift	=	model_BPL__Swift( x__Swift_short, nu1__BATSE, nu2__BATSE, coeff__BATSE, delta__BATSE, chi__BATSE ) * N__Swift
...
model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short, nu1__BATSE, nu2__BATSE, coeff__BATSE, delta__BATSE, chi__BATSE ) * N__BATSE
#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short, nu1__Fermi, nu2__Fermi, coeff__Fermi, delta__Fermi, chi__Fermi ) * N__BATSE
...
ECPL_table			=	ascii.read( './../tables/ECPL--bestfit.txt', format = 'fixed_width' )
x_ECPL_fit			=	ECPL_table['L/L0'].data
ECPL_model_Fermi	=	ECPL_table['Fermi_fit'].data
ECPL_model_BATSE	=	ECPL_table['BATSE_fit'].data

#	print '\n\n\n\n', (x_ECPL_fit - x__Fermi_short == 0).all(), '\n\n\n\n'
...
ax.errorbar( x__Fermi_short, y__Fermi_short, yerr = [ y__Fermi_short_poserr, y__Fermi_short_negerr ], fmt = '--', label = r' $ Fermi $' )
ax.errorbar( x__Swift_short, y__Swift_short, yerr = [ y__Swift_short_poserr, y__Swift_short_negerr ], fmt = '--', label = r' $ Swift $' )
ax.step( x__Fermi_short, model_fit__BATSE, where = 'mid', linestyle = '--', color = 'k', label = r' $ \rm{ \,BPL \; model } $' )
ax.step( x__Fermi_short, ECPL_model_BATSE, where = 'mid', linestyle = '-' , color = 'k', label = r' $ \rm{  ECPL \; model } $' )
ax.legend()
plt.savefig('./../plots/estimated_lumfunc_models/combined.png')
plt.savefig('./../plots/estimated_lumfunc_models/combined.pdf')
plt.clf()
plt.close()
