...
def k_correction_factor_with_fixed_spectral_parameters__BATSE(z):
...
def Liso_with_fixed_spectral_parameters__BATSE( ef, z ):
	
	return ef * 4*P * dL(z)**2 * k_correction_factor_with_fixed_spectral_parameters__BATSE(z)
