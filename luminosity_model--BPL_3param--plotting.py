...
Gamma__Fermi = 0.001 ; nu1__Fermi = 0.482 ; nu2__Fermi = 1.858 ; coeff__Fermi = 1.523	# n = 1.0
#~ Gamma__Fermi = 0.001 ; nu1__Fermi = 0.381 ; nu2__Fermi = 1.849 ; coeff__Fermi = 1.458	# n = 1.5
#~ Gamma__Fermi = 0.001 ; nu1__Fermi = 0.339 ; nu2__Fermi = 1.845 ; coeff__Fermi = 1.446	# n = 2.0
...
#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short, Gamma__BATSE, nu1__BATSE, nu2__BATSE, coeff__BATSE ) * N__BATSE

#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short, Gamma__Fermi, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__BATSE
model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short,         0.17, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__BATSE	# n = 1.0
#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short,         0.16, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__BATSE	# n = 1.5
#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short,         0.15, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__BATSE	# n = 2.0

#~ model_fit__BATSE	=	model_BPL__BATSE( x__BATSE_short, Gamma__Swift, nu1__Swift, nu2__Swift, coeff__Swift ) * N__BATSE
...
#~ model_fit__Fermi	=	model_BPL__Fermi( x__Fermi_short, Gamma__BATSE, nu1__BATSE, nu2__BATSE, coeff__BATSE ) * N__Fermi

model_fit__Fermi	=	model_BPL__Fermi( x__Fermi_short, Gamma__Fermi, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__Fermi

#~ model_fit__Fermi	=	model_BPL__Fermi( x__Fermi_short, Gamma__Swift, nu1__Swift, nu2__Swift, coeff__Swift ) * N__Fermi
...
#~ model_fit__Swift	=	model_BPL__Swift( x__Swift_short, Gamma__BATSE, nu1__BATSE, nu2__BATSE, coeff__BATSE ) * N__Swift

model_fit__Swift	=	model_BPL__Swift( x__Swift_short, Gamma__Fermi, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * N__Swift

#~ model_fit__Swift	=	model_BPL__Swift( x__Swift_short, Gamma__Swift, nu1__Swift, nu2__Swift, coeff__Swift ) * N__Swift
...
#~ ax.step( x__BATSE_short, model_fit__BATSE, where = 'mid', linestyle = '--', color = 'k', label = r' $ \Gamma = 0.17, n = 1.0 \, \rm{model} $' )
ax.legend()
plt.savefig( './../plots/3param--joint--n={0:.1f}.png'.format(n) )
plt.savefig( './../plots/3param--joint--n={0:.1f}.pdf'.format(n) )
plt.clf()
plt.close()
...
ax.legend()
plt.savefig( './../plots/3param--joint--BATSE--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
...
ax.step( x__Fermi_short, model_fit__Fermi, where = 'mid', linestyle = '-' , color = 'k', label = r' $ \rm{model} $' )
ax.legend()
plt.savefig( './../plots/3param--joint--Fermi--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
...
ax.legend()
plt.savefig( './../plots/3param--joint--Swift--n={0:.1f}.png'.format(n) )
plt.clf()
plt.close()
...
norm_while_plotting_Fermi	=	1.107e-08	# n = 1.0
#~ norm_while_plotting_Fermi	=	6.078e-09	# n = 1.5
#~ norm_while_plotting_Fermi	=	3.633e-09	# n = 2.0
...
model_ACZTI__Fermi	=	model_BPL__ACZTI( x__Fermi_short, Gamma__Fermi, nu1__Fermi, nu2__Fermi, coeff__Fermi ) * norm_ACZTI__Fermi_model
...
#~ ax.legend( loc = 'best' )
#~ plt.savefig( './../plots/3param--ACZTI--n={0:.1f}.png'.format(n) )
#~ plt.clf()
#~ plt.close()
