...
def model_ECPL__Fermi( x__Fermi_short, nu, coeff ):
...
def model_ECPL__Swift( x__Swift_short, nu, coeff ):
...
def model_ECPL__BATSE( x__BATSE_short, nu, coeff ):
...
nu_l = 0.60 ; coeff_l = 5.40

lower_bounds	=	[0.0, 0.00]
upper_bounds	=	[4.0, 10.0]
...
popt__Fermi, pcov__Fermi	=	curve_fit( model_ECPL__Fermi, x__Fermi_short, y__Fermi_short/N__Fermi, p0 = [nu_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
...
popt__Swift, pcov__Swift	=	curve_fit( model_ECPL__Swift, x__Swift_short, y__Swift_short/N__Swift, p0 = [nu_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
...
popt__BATSE, pcov__BATSE	=	curve_fit( model_ECPL__BATSE, x__BATSE_short, y__BATSE_short/N__BATSE, p0 = [nu_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
