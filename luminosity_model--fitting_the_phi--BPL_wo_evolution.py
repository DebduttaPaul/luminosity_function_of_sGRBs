...
def model_BPL__Fermi( x__Fermi_short, nu1, nu2, coeff ):
...
def model_BPL__Swift( x__Swift_short, nu1, nu2, coeff ):
...
def model_BPL__BATSE( x__BATSE_short, nu1, nu2, coeff ):
...
nu1_l = 0.10 ; nu2_l = 3.10 ; coeff_l = 0.30

lower_bounds	=	[0.0, 0.0, 0.0]
upper_bounds	=	[2.0, 6.0, 7.0]
...
popt__Fermi, pcov__Fermi	=	curve_fit( model_BPL__Fermi, x__Fermi_short, y__Fermi_short/N__Fermi, p0 = [nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
...
popt__Swift, pcov__Swift	=	curve_fit( model_BPL__Swift, x__Swift_short, y__Swift_short/N__Swift, p0 = [nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
...
popt__BATSE, pcov__BATSE	=	curve_fit( model_BPL__BATSE, x__BATSE_short, y__BATSE_short/N__BATSE, p0 = [nu1_l, nu2_l, coeff_l], bounds = (lower_bounds, upper_bounds)  )
